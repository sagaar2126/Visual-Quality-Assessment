...
# -*- coding: utf-8 -*-
"""
Created on Tue Feb 15 13:07:53 2022
...
import torch
import pandas as pd
from dataset.livec import LiveIQ
...
for i in range(1,6):
    ...
    train_set    =  LiveIQ(x_train , path_to_feat+"/" , y_train)
    test_set     =  LiveIQ(x_test , path_to_feat+"/" , y_test)
